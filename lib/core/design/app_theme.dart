  ...
  static TextTheme _textTheme(Color ink, Color muted) {
    ...
    return TextTheme(
      displaySmall: TextStyle(
        ...
        height: 1.15, letterSpacing: -0.5, color: ink,
      ),
      headlineMedium: TextStyle(
        fontFamily: family, fontSize: 26, fontWeight: FontWeight.w800,
        height: 1.2, letterSpacing: -0.4, color: ink,
      ),
      headlineSmall: TextStyle(
        fontFamily: family, fontSize: 22, fontWeight: FontWeight.w700,
        height: 1.25, letterSpacing: -0.3, color: ink,
      ),
      titleLarge: TextStyle(
        fontFamily: family, fontSize: 18, fontWeight: FontWeight.w700,
        height: 1.3, color: ink,
      ),
      titleMedium: TextStyle(
        fontFamily: family, fontSize: 16, fontWeight: FontWeight.w600,
        height: 1.35, color: ink,
      ),
      ...
      labelMedium: TextStyle(
        fontFamily: family, fontSize: 13, fontWeight: FontWeight.w500,
        color: ink,
      ),
      labelSmall: TextStyle(
        fontFamily: family, fontSize: 11, fontWeight: FontWeight.w500,
